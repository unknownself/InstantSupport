							...
							<div class="box-body box-body-nopadding">
								<?php
									if($_POST['submit']) {
										...
										if(!empty($pw)) {
											$query = $db->query('UPDATE `operators` SET `password`="'.$pw.'",`full_name`="'.$fn.'" WHERE `username`="'.$_SESSION['user'].'"');
											echo 'Updated settings successfully.';	
										} else {
											$query = $db->query('UPDATE `operators` SET `full_name`="'.$fn.'" WHERE `username`="'.$_SESSION['user'].'"');
											echo 'Updated settings successfully.';	
										}
									} else {
										$query = $db->query('SELECT * FROM `operators` WHERE `username`="'.$_SESSION['user'].'"');	
									...
									<div class="control-group">
										...
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												<div class="fileupload-new thumbnail" style="width: 80px; height: 80px;"><img src="http://www.placehold.it/80/EFEFEF/AAAAAA&amp;text=staff"></div>
